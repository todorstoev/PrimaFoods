...
pll_register_string("Bulgaria", "Bulgaria", $context = 'primaFoods', $multiline = true);
pll_register_string("Factory", "Factory", $context = 'primaFoods', $multiline = true);
pll_register_string("West Industrial Zone", "West Industrial Zone", $context = 'primaFoods', $multiline = true);
pll_register_string("Pleven, 5800, Bulgaria", "Pleven, 5800, Bulgaria", $context = 'primaFoods', $multiline = true);
pll_register_string("Office", "Office", $context = 'primaFoods', $multiline = true);
pll_register_string("20 Al.Stamboliiski blvd", "20 Al.Stamboliiski blvd", $context = 'primaFoods', $multiline = true);
pll_register_string("Sofia, 1000, Bulgaria", "Sofia, 1000, Bulgaria", $context = 'primaFoods', $multiline = true);
pll_register_string("Back", "Back", $context = 'primaFoods', $multiline = true);
